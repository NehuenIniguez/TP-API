...
export class LangSelectors extends Scene {
    #textSpanish;
    #textEnglish;
    ...
    async obtenerTraducciones(language) {
        ...
        await getTranslations(language, this.updateWasChangedLanguage.bind(this));

        // Reactivar botones una vez que se reciban las traducciones
